...
public class QueController {
   ...
   public Result add(Que que){
    ...
    @RequestMapping("findAllLikes")
    public Result findAllLikes(Que que){
        List<Que> all = queService.findAllLikes(que);
        System.out.println("findAllLikes"+que);
        System.out.println("findAllLikes"+all);
        return Result.success(all);
    }
}
